...
class ApiClient {
  ...
  // Internships APIs
  async getInternships(params?: unknown) {
  ...
  // Scholarships APIs
  async getScholarships(params?: unknown) {
  ...
  // Articles APIs
  async getArticles(params?: unknown) {
  ...
  // DSA Topics APIs
  async getDSATopics(params?: unknown) {
  ...
  // DSA Questions APIs
  async getDSAQuestions(params?: unknown) {
  ...
  async submitDSAQuestion(id: string, data: unknown) {
    const response = await this.client.post(`/user/dsa/questions/${id}/submit`, data);
    return response.data;
  }

  // DSA Sheets APIs
  async getDSASheets(params?: unknown) {
  ...
  // DSA Companies APIs
  async getDSACompanies(params?: unknown) {
  ...
  // Roadmaps APIs
  async getRoadmaps(params?: unknown) {
