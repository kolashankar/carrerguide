          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {topCompanies.length > 0 ? (
                topCompanies.map((company: unknown) => (
                  <Link
                    key={company._id}
                    href={`/dsa/companies`}
      ...
      <FAQ items={[
        {
          ...
          answer: 'We offer problems in three difficulty levels: Easy, Medium, and Hard. Start with Easy if you\'re a beginner and gradually work your way up.'
        },
        {
          question: 'Can I filter problems by company?',
          answer: 'Yes! Our DSA Corner allows you to filter problems by specific companies to prepare for their interview process.'
        },
        {
          question: 'Are there curated problem sheets available?',
          answer: 'Absolutely! We have curated DSA sheets like Striver\'s SDE Sheet, NeetCode 150, and company-specific lists to guide your preparation.'
        },
        {
          question: 'How do I track my progress?',
          answer: 'Visit your profile dashboard to track solved problems, maintain streaks, and monitor your overall DSA preparation progress.'
        },
      ]} />
