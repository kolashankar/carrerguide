...
`;var N=F},82704:()=>{},86732:(a,b,c)=>{"use strict";c.d(b,{A:()=>e});let d=c(12989).A.create({baseURL:"http://localhost:8001/api",headers:{"Content-Type":"application/json"}});d.interceptors.request.use(a=>a,a=>Promise.reject(a)),d.interceptors.response.use(a=>a,a=>(a.response?.status===401&&console.error("Unauthorized access"),Promise.reject(a)));let e=d},91354:(a,b,c)=>{Promise.resolve().then(c.t.bind(c,81170,23)),Promise.resolve().then(c.t.bind(c,23597,23)),Promise.resolve().then(c.t.bind(c,36893,23)),Promise.resolve().then(c.t.bind(c,89748,23)),Promise.resolve().then(c.t.bind(c,6060,23)),Promise.resolve().then(c.t.bind(c,7184,23)),Promise.resolve().then(c.t.bind(c,69576,23)),Promise.resolve().then(c.t.bind(c,73041,23)),Promise.resolve().then(c.t.bind(c,51384,23))},99299:(a,b,c)=>{"use strict";c.d(b,{d:()=>e});var d=c(86732);let e={getAll:a=>d.A.get("/admin/users",{params:a}),getById:a=>d.A.get(`/admin/users/${a}`),update:(a,b)=>d.A.put(`/admin/users/${a}`,b),ban:(a,b)=>d.A.post(`/admin/users/${a}/ban`,{reason:b}),unban:a=>d.A.post(`/admin/users/${a}/unban`),getActivity:(a,b)=>d.A.get(`/admin/users/${a}/activity`,{params:b}),getSegments:()=>d.A.get("/admin/users/segments"),getStats:()=>d.A.get("/admin/users/stats")}}};