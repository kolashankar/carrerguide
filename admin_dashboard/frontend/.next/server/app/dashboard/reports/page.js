...
`;var N=F},74075:a=>{"use strict";a.exports=require("zlib")},79551:a=>{"use strict";a.exports=require("url")},81630:a=>{"use strict";a.exports=require("http")},82704:()=>{},83997:a=>{"use strict";a.exports=require("tty")},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},86732:(a,b,c)=>{"use strict";c.d(b,{A:()=>e});let d=c(12989).A.create({baseURL:"http://localhost:8001/api",headers:{"Content-Type":"application/json"}});d.interceptors.request.use(a=>a,a=>Promise.reject(a)),d.interceptors.response.use(a=>a,a=>(a.response?.status===401&&console.error("Unauthorized access"),Promise.reject(a)));let e=d},88141:(a,b,c)=>{"use strict";c.r(b),c.d(b,{default:()=>k});var d=c(21124),e=c(38301),f=c(86732);let g={buildReport:a=>f.A.post("/admin/reports/build",a),exportPDF:a=>f.A.post("/admin/reports/export/pdf",a,{responseType:"blob"}),exportCSV:a=>f.A.post("/admin/reports/export/csv",a,{responseType:"blob"})};var h=c(66518),i=c(3991),j=c.n(i);function k(){let[a,b]=(0,e.useState)(!1),[c,f]=(0,e.useState)("users"),[i,k]=(0,e.useState)("30"),l=async()=>{try{b(!0);let a={type:c,date_range:parseInt(i)};await g.buildReport(a),h.Ay.success("Report generated successfully")}catch(a){h.Ay.error("Failed to generate report"),console.error(a)}finally{b(!1)}},m=async()=>{try{let a={type:c,date_range:parseInt(i)},b=await g.exportPDF(a),d=new Blob([b.data],{type:"application/pdf"}),e=window.URL.createObjectURL(d),f=document.createElement("a");f.href=e,f.download=`report_${Date.now()}.pdf`,f.click(),h.Ay.success("PDF exported successfully")}catch(a){h.Ay.error("Failed to export PDF")}},n=async()=>{try{let a={type:c,date_range:parseInt(i)},b=await g.exportCSV(a),d=new Blob([b.data],{type:"text/csv"}),e=window.URL.createObjectURL(d),f=document.createElement("a");f.href=e,f.download=`report_${Date.now()}.csv`,f.click(),h.Ay.success("CSV exported successfully")}catch(a){h.Ay.error("Failed to export CSV")}};return(0,d.jsxs)("div",{className:"p-6",children:[(0,d.jsx)("h1",{className:"text-3xl font-bold mb-6",children:"Reports"}),(0,d.jsxs)("div",{className:"grid grid-cols-1 md:grid-cols-3 gap-4 mb-6",children:[(0,d.jsxs)(j(),{href:"/dashboard/reports/builder",className:"bg-white p-6 rounded-lg shadow hover:shadow-lg text-center",children:[(0,d.jsx)("div",{className:"text-4xl mb-3",children:"\uD83D\uDD27"}),(0,d.jsx)("h3",{className:"text-lg font-bold",children:"Report Builder"}),(0,d.jsx)("p",{className:"text-sm text-gray-600 mt-1",children:"Create custom reports"})]}),(0,d.jsxs)(j(),{href:"/dashboard/reports/scheduled",className:"bg-white p-6 rounded-lg shadow hover:shadow-lg text-center",children:[(0,d.jsx)("div",{className:"text-4xl mb-3",children:"⏰"}),(0,d.jsx)("h3",{className:"text-lg font-bold",children:"Scheduled Reports"}),(0,d.jsx)("p",{className:"text-sm text-gray-600 mt-1",children:"Automated reporting"})]}),(0,d.jsxs)(j(),{href:"/dashboard/reports/email",className:"bg-white p-6 rounded-lg shadow hover:shadow-lg text-center",children:[(0,d.jsx)("div",{className:"text-4xl mb-3",children:"\uD83D\uDCE7"}),(0,d.jsx)("h3",{className:"text-lg font-bold",children:"Email Reports"}),(0,d.jsx)("p",{className:"text-sm text-gray-600 mt-1",children:"Send reports via email"})]})]}),(0,d.jsxs)("div",{className:"bg-white p-6 rounded-lg shadow",children:[(0,d.jsx)("h2",{className:"text-xl font-bold mb-4",children:"Quick Report Generator"}),(0,d.jsxs)("div",{className:"space-y-4",children:[(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Report Type"}),(0,d.jsxs)("select",{value:c,onChange:a=>f(a.target.value),className:"w-full px-4 py-2 border rounded-lg",children:[(0,d.jsx)("option",{value:"users",children:"User Statistics"}),(0,d.jsx)("option",{value:"jobs",children:"Jobs Report"}),(0,d.jsx)("option",{value:"internships",children:"Internships Report"}),(0,d.jsx)("option",{value:"applications",children:"Applications Report"}),(0,d.jsx)("option",{value:"revenue",children:"Revenue Report"}),(0,d.jsx)("option",{value:"engagement",children:"Engagement Metrics"})]})]}),(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Date Range"}),(0,d.jsxs)("select",{value:i,onChange:a=>k(a.target.value),className:"w-full px-4 py-2 border rounded-lg",children:[(0,d.jsx)("option",{value:"7",children:"Last 7 Days"}),(0,d.jsx)("option",{value:"30",children:"Last 30 Days"}),(0,d.jsx)("option",{value:"90",children:"Last 90 Days"}),(0,d.jsx)("option",{value:"365",children:"Last Year"})]})]}),(0,d.jsxs)("div",{className:"flex gap-4",children:[(0,d.jsx)("button",{onClick:l,disabled:a,className:"bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50",children:a?"Generating...":"Generate Report"}),(0,d.jsx)("button",{onClick:m,className:"bg-red-600 text-white px-6 py-2 rounded-lg hover:bg-red-700",children:"Export PDF"}),(0,d.jsx)("button",{onClick:n,className:"bg-green-600 text-white px-6 py-2 rounded-lg hover:bg-green-700",children:"Export CSV"})]})]})]})]})}},91354:(a,b,c)=>{Promise.resolve().then(c.t.bind(c,81170,23)),Promise.resolve().then(c.t.bind(c,23597,23)),Promise.resolve().then(c.t.bind(c,36893,23)),Promise.resolve().then(c.t.bind(c,89748,23)),Promise.resolve().then(c.t.bind(c,6060,23)),Promise.resolve().then(c.t.bind(c,7184,23)),Promise.resolve().then(c.t.bind(c,69576,23)),Promise.resolve().then(c.t.bind(c,73041,23)),Promise.resolve().then(c.t.bind(c,51384,23))},94735:a=>{"use strict";a.exports=require("events")},96298:(a,b,c)=>{Promise.resolve().then(c.bind(c,16005))}};var b=require("../../../webpack-runtime.js");b.C(a);var c=b.X(0,[6778,2989,3991],()=>b(b.s=52597));module.exports=c})();