...
`;var N=F},68784:(a,b,c)=>{Promise.resolve().then(c.bind(c,99401))},74075:a=>{"use strict";a.exports=require("zlib")},79551:a=>{"use strict";a.exports=require("url")},81630:a=>{"use strict";a.exports=require("http")},82704:()=>{},83997:a=>{"use strict";a.exports=require("tty")},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},86732:(a,b,c)=>{"use strict";c.d(b,{A:()=>e});let d=c(12989).A.create({baseURL:"http://localhost:8001/api",headers:{"Content-Type":"application/json"}});d.interceptors.request.use(a=>a,a=>Promise.reject(a)),d.interceptors.response.use(a=>a,a=>(a.response?.status===401&&console.error("Unauthorized access"),Promise.reject(a)));let e=d},91354:(a,b,c)=>{Promise.resolve().then(c.t.bind(c,81170,23)),Promise.resolve().then(c.t.bind(c,23597,23)),Promise.resolve().then(c.t.bind(c,36893,23)),Promise.resolve().then(c.t.bind(c,89748,23)),Promise.resolve().then(c.t.bind(c,6060,23)),Promise.resolve().then(c.t.bind(c,7184,23)),Promise.resolve().then(c.t.bind(c,69576,23)),Promise.resolve().then(c.t.bind(c,73041,23)),Promise.resolve().then(c.t.bind(c,51384,23))},94735:a=>{"use strict";a.exports=require("events")},98847:(a,b,c)=>{"use strict";c.r(b),c.d(b,{default:()=>d});let d=(0,c(97954).registerClientReference)(function(){throw Error("Attempted to call the default export of \"/app/admin_dashboard/frontend/app/dashboard/content-approval/page.tsx\" from the server, but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.")},"/app/admin_dashboard/frontend/app/dashboard/content-approval/page.tsx","default")},99401:(a,b,c)=>{"use strict";c.r(b),c.d(b,{default:()=>i});var d=c(21124),e=c(38301),f=c(86732);let g={getPending:a=>f.A.get("/admin/content/pending",{params:a}),approve:(a,b)=>f.A.post(`/admin/content/${a}/approve`,{comment:b}),reject:(a,b)=>f.A.post(`/admin/content/${a}/reject`,{comment:b})};var h=c(66518);function i(){let[a,b]=(0,e.useState)([]),[c,f]=(0,e.useState)(!0),[i,j]=(0,e.useState)(null),k=async()=>{try{f(!0);let a=await g.getPending();b(a.data.submissions||[])}catch(a){h.Ay.error("Failed to fetch pending items"),console.error(a)}finally{f(!1)}},l=async a=>{let b=prompt("Add approval comment (optional):");try{await g.approve(a,b||void 0),h.Ay.success("Content approved successfully"),k()}catch(a){h.Ay.error("Failed to approve content")}},m=async a=>{let b=prompt("Rejection reason (required):");if(b)try{await g.reject(a,b),h.Ay.success("Content rejected"),k()}catch(a){h.Ay.error("Failed to reject content")}};return(0,d.jsxs)("div",{className:"p-6",children:[(0,d.jsx)("h1",{className:"text-3xl font-bold mb-6",children:"Content Approval Workflow"}),c?(0,d.jsx)("div",{className:"text-center py-12",children:"Loading..."}):0===a.length?(0,d.jsx)("div",{className:"text-center py-12 text-gray-500",children:"No pending approvals"}):(0,d.jsx)("div",{className:"grid gap-4",children:a.map(a=>(0,d.jsx)("div",{className:"bg-white p-6 rounded-lg shadow",children:(0,d.jsxs)("div",{className:"flex justify-between items-start",children:[(0,d.jsxs)("div",{className:"flex-1",children:[(0,d.jsxs)("div",{className:"flex items-center gap-3 mb-2",children:[(0,d.jsx)("h3",{className:"text-xl font-bold",children:a.title}),(0,d.jsx)("span",{className:"px-2 py-1 rounded text-xs bg-yellow-100 text-yellow-800",children:a.content_type})]}),(0,d.jsx)("p",{className:"text-gray-600 mb-3",children:a.description}),(0,d.jsxs)("div",{className:"flex gap-4 text-sm text-gray-500",children:[(0,d.jsxs)("span",{children:["Submitted by: ",a.submitted_by]}),(0,d.jsxs)("span",{children:["Date: ",new Date(a.submitted_at).toLocaleDateString()]})]})]}),(0,d.jsxs)("div",{className:"flex flex-col gap-2 ml-4",children:[(0,d.jsx)("button",{onClick:()=>j(a),className:"text-blue-600 hover:underline text-sm",children:"View Details"}),(0,d.jsx)("button",{onClick:()=>l(a._id),className:"bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 text-sm",children:"Approve"}),(0,d.jsx)("button",{onClick:()=>m(a._id),className:"bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 text-sm",children:"Reject"})]})]})},a._id))}),i&&(0,d.jsx)("div",{className:"fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4",children:(0,d.jsxs)("div",{className:"bg-white p-6 rounded-lg w-full max-w-3xl max-h-[80vh] overflow-y-auto",children:[(0,d.jsx)("h2",{className:"text-2xl font-bold mb-4",children:i.title}),(0,d.jsxs)("div",{className:"prose max-w-none mb-4",children:[(0,d.jsxs)("p",{children:[(0,d.jsx)("strong",{children:"Type:"})," ",i.content_type]}),(0,d.jsxs)("p",{children:[(0,d.jsx)("strong",{children:"Submitted by:"})," ",i.submitted_by]}),(0,d.jsxs)("p",{children:[(0,d.jsx)("strong",{children:"Submitted at:"})," ",new Date(i.submitted_at).toLocaleString()]}),(0,d.jsxs)("div",{className:"mt-4",children:[(0,d.jsx)("strong",{children:"Content:"}),(0,d.jsx)("div",{className:"mt-2 p-4 bg-gray-50 rounded",children:JSON.stringify(i.content,null,2)})]})]}),(0,d.jsx)("button",{onClick:()=>j(null),className:"bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400",children:"Close"})]})})]})}}};var b=require("../../../webpack-runtime.js");b.C(a);var c=b.X(0,[6778,2989],()=>b(b.s=49367));module.exports=c})();