...
`;var N=F},74075:a=>{"use strict";a.exports=require("zlib")},79551:a=>{"use strict";a.exports=require("url")},80228:(a,b,c)=>{"use strict";c.r(b),c.d(b,{default:()=>i});var d=c(21124),e=c(38301),f=c(42378),g=c(60279),h=c(66518);function i(){let a=(0,f.useRouter)(),[b,c]=(0,e.useState)(!1),[i,j]=(0,e.useState)({topic:"",difficulty:"Medium",companies:"",focus_area:""}),k=async b=>{b.preventDefault(),c(!0);try{let b=await g.L.questions.generateAI(i);h.Ay.success("Question generated successfully"),b.data._id?a.push(`/dashboard/dsa/questions/edit/${b.data._id}`):a.push("/dashboard/dsa/questions/list")}catch(a){h.Ay.error(a.response?.data?.detail||"Failed to generate question"),console.error(a)}finally{c(!1)}};return(0,d.jsxs)("div",{className:"p-6 max-w-2xl mx-auto",children:[(0,d.jsx)("h1",{className:"text-3xl font-bold mb-6",children:"Generate DSA Question with AI"}),(0,d.jsx)("form",{onSubmit:k,className:"bg-white p-6 rounded-lg shadow",children:(0,d.jsxs)("div",{className:"space-y-4",children:[(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Topic *"}),(0,d.jsx)("input",{type:"text",required:!0,value:i.topic,onChange:a=>j({...i,topic:a.target.value}),placeholder:"e.g. Binary Search, Dynamic Programming",className:"w-full px-4 py-2 border rounded-lg"})]}),(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Difficulty *"}),(0,d.jsxs)("select",{required:!0,value:i.difficulty,onChange:a=>j({...i,difficulty:a.target.value}),className:"w-full px-4 py-2 border rounded-lg",children:[(0,d.jsx)("option",{value:"Easy",children:"Easy"}),(0,d.jsx)("option",{value:"Medium",children:"Medium"}),(0,d.jsx)("option",{value:"Hard",children:"Hard"})]})]}),(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Companies (comma separated)"}),(0,d.jsx)("input",{type:"text",value:i.companies,onChange:a=>j({...i,companies:a.target.value}),placeholder:"e.g. Google, Amazon, Microsoft",className:"w-full px-4 py-2 border rounded-lg"})]}),(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Focus Area (optional)"}),(0,d.jsx)("textarea",{value:i.focus_area,onChange:a=>j({...i,focus_area:a.target.value}),placeholder:"e.g. Focus on edge cases, optimization techniques",className:"w-full px-4 py-2 border rounded-lg",rows:3})]}),(0,d.jsx)("div",{className:"bg-purple-50 p-4 rounded-lg",children:(0,d.jsxs)("p",{className:"text-sm text-purple-800",children:[(0,d.jsx)("strong",{children:"AI Generation:"})," The AI will create a comprehensive DSA question including problem statement, solution approach, code in multiple languages, hints, and complexity analysis."]})}),(0,d.jsxs)("div",{className:"flex gap-4 pt-4",children:[(0,d.jsx)("button",{type:"submit",disabled:b,className:"bg-purple-600 text-white px-6 py-2 rounded-lg hover:bg-purple-700 disabled:opacity-50 flex items-center gap-2",children:b?(0,d.jsxs)(d.Fragment,{children:[(0,d.jsx)("span",{className:"animate-spin",children:"⚙️"}),"Generating..."]}):(0,d.jsx)(d.Fragment,{children:"✨ Generate with AI"})}),(0,d.jsx)("button",{type:"button",onClick:()=>a.back(),className:"bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400",children:"Cancel"})]})]})})]})}},81630:a=>{"use strict";a.exports=require("http")},82704:()=>{},83997:a=>{"use strict";a.exports=require("tty")},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},86732:(a,b,c)=>{"use strict";c.d(b,{A:()=>e});let d=c(12989).A.create({baseURL:"http://localhost:8001/api",headers:{"Content-Type":"application/json"}});d.interceptors.request.use(a=>a,a=>Promise.reject(a)),d.interceptors.response.use(a=>a,a=>(a.response?.status===401&&console.error("Unauthorized access"),Promise.reject(a)));let e=d},91354:(a,b,c)=>{Promise.resolve().then(c.t.bind(c,81170,23)),Promise.resolve().then(c.t.bind(c,23597,23)),Promise.resolve().then(c.t.bind(c,36893,23)),Promise.resolve().then(c.t.bind(c,89748,23)),Promise.resolve().then(c.t.bind(c,6060,23)),Promise.resolve().then(c.t.bind(c,7184,23)),Promise.resolve().then(c.t.bind(c,69576,23)),Promise.resolve().then(c.t.bind(c,73041,23)),Promise.resolve().then(c.t.bind(c,51384,23))},94735:a=>{"use strict";a.exports=require("events")}};var b=require("../../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[6778,2989],()=>b(b.s=6749));module.exports=c})();