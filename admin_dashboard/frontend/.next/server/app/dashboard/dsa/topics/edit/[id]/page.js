...
`;var N=F},71878:(a,b,c)=>{"use strict";c.r(b),c.d(b,{default:()=>i});var d=c(21124),e=c(38301),f=c(42378),g=c(60279),h=c(66518);function i(){let a=(0,f.useRouter)(),b=(0,f.useParams)().id,[c,i]=(0,e.useState)(!1),[j,k]=(0,e.useState)(!0),[l,m]=(0,e.useState)({name:"",description:"",icon:"\uD83D\uDCDA",color:"#3b82f6",is_active:!0}),n=async c=>{c.preventDefault(),i(!0);try{await g.L.topics.update(b,l),h.Ay.success("Topic updated successfully"),a.push("/dashboard/dsa/topics/list")}catch(a){h.Ay.error(a.response?.data?.detail||"Failed to update topic"),console.error(a)}finally{i(!1)}};return j?(0,d.jsx)("div",{className:"p-6 text-center",children:"Loading topic..."}):(0,d.jsxs)("div",{className:"p-6 max-w-2xl mx-auto",children:[(0,d.jsx)("h1",{className:"text-3xl font-bold mb-6",children:"Edit DSA Topic"}),(0,d.jsx)("form",{onSubmit:n,className:"bg-white p-6 rounded-lg shadow",children:(0,d.jsxs)("div",{className:"space-y-4",children:[(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Name *"}),(0,d.jsx)("input",{type:"text",required:!0,value:l.name,onChange:a=>m({...l,name:a.target.value}),className:"w-full px-4 py-2 border rounded-lg"})]}),(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Description *"}),(0,d.jsx)("textarea",{required:!0,value:l.description,onChange:a=>m({...l,description:a.target.value}),className:"w-full px-4 py-2 border rounded-lg",rows:4})]}),(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Icon"}),(0,d.jsx)("div",{className:"flex gap-2 mb-2",children:["\uD83D\uDCDA","\uD83D\uDCCA","\uD83D\uDD0D","\uD83E\uDDE0","\uD83D\uDCBB","\uD83C\uDFAF","⚙️","\uD83D\uDD12","\uD83C\uDF33","\uD83D\uDCCA"].map(a=>(0,d.jsx)("button",{type:"button",onClick:()=>m({...l,icon:a}),className:`text-2xl p-2 rounded border ${l.icon===a?"border-blue-500 bg-blue-50":"border-gray-300"}`,children:a},a))}),(0,d.jsx)("input",{type:"text",value:l.icon,onChange:a=>m({...l,icon:a.target.value}),className:"w-full px-4 py-2 border rounded-lg",placeholder:"Or enter custom emoji"})]}),(0,d.jsxs)("div",{children:[(0,d.jsx)("label",{className:"block text-sm font-medium mb-2",children:"Color"}),(0,d.jsx)("input",{type:"color",value:l.color,onChange:a=>m({...l,color:a.target.value}),className:"w-full h-12 border rounded-lg"})]}),(0,d.jsxs)("div",{className:"flex items-center",children:[(0,d.jsx)("input",{type:"checkbox",checked:l.is_active,onChange:a=>m({...l,is_active:a.target.checked}),className:"mr-2"}),(0,d.jsx)("label",{className:"text-sm font-medium",children:"Active"})]}),(0,d.jsxs)("div",{className:"flex gap-4 pt-4",children:[(0,d.jsx)("button",{type:"submit",disabled:c,className:"bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 disabled:opacity-50",children:c?"Updating...":"Update Topic"}),(0,d.jsx)("button",{type:"button",onClick:()=>a.back(),className:"bg-gray-300 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-400",children:"Cancel"})]})]})})]})}},74075:a=>{"use strict";a.exports=require("zlib")},79551:a=>{"use strict";a.exports=require("url")},81630:a=>{"use strict";a.exports=require("http")},82704:()=>{},83997:a=>{"use strict";a.exports=require("tty")},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},86732:(a,b,c)=>{"use strict";c.d(b,{A:()=>e});let d=c(12989).A.create({baseURL:"http://localhost:8001/api",headers:{"Content-Type":"application/json"}});d.interceptors.request.use(a=>a,a=>Promise.reject(a)),d.interceptors.response.use(a=>a,a=>(a.response?.status===401&&console.error("Unauthorized access"),Promise.reject(a)));let e=d},91354:(a,b,c)=>{Promise.resolve().then(c.t.bind(c,81170,23)),Promise.resolve().then(c.t.bind(c,23597,23)),Promise.resolve().then(c.t.bind(c,36893,23)),Promise.resolve().then(c.t.bind(c,89748,23)),Promise.resolve().then(c.t.bind(c,6060,23)),Promise.resolve().then(c.t.bind(c,7184,23)),Promise.resolve().then(c.t.bind(c,69576,23)),Promise.resolve().then(c.t.bind(c,73041,23)),Promise.resolve().then(c.t.bind(c,51384,23))},94391:(a,b,c)=>{Promise.resolve().then(c.bind(c,12008))},94735:a=>{"use strict";a.exports=require("events")}};var b=require("../../../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[6778,2989],()=>b(b.s=36003));module.exports=c})();