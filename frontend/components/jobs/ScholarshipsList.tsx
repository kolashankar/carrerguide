            ...
            >
              <View className="flex-row justify-between items-start mb-3">
                <View className="flex-1 mr-3">
                  ...
                  <Text className="text-gray-600 text-sm mt-1.5">{scholarship.provider}</Text>
                </View>
                <View className="flex-row items-center">
                  ...
                  <TouchableOpacity 
                    onPress={(e) => handleBookmark(scholarship, e)}
                    className="p-1"
                  ...
                  >
                    <Ionicons
                      ...
                      size={22}
                      color={
                        bookmarkedScholarships.has(scholarship._id) ? '#2563eb' : '#9ca3af'
                      }
                    />
                  </TouchableOpacity>
                </View>
              ...
              <View className="flex-row flex-wrap mt-2">
                <View className="flex-row items-center mr-4 mb-2">
                  ...
                  <Text className="text-gray-600 text-xs ml-1.5">{scholarship.country}</Text>
                </View>
                <View className="flex-row items-center mr-4 mb-2">
